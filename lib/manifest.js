...
Manifest.prototype.checkMimeType = function() {
  if (this.mimeType && this.mimeType.indexOf('text/cache-manifest') === 0) { return true; }
...
Manifest.prototype.validate = function() {
  var manifest = _stringToArray(this.content),
